...
namespace WCFSelf_Host.ProfileProxy {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(WCFSelf_Host.ProfileProxy.Group))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(WCFSelf_Host.ProfileProxy.Chat))]
    ...
    [System.SerializableAttribute()]
    public partial class Group : WCFSelf_Host.ProfileProxy.Activity {
    ...
    [System.SerializableAttribute()]
    public partial class Chat : WCFSelf_Host.ProfileProxy.Activity {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private System.Tuple<WCFSelf_Host.ProfileProxy.Profile, object, string>[] UsersField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Tuple<WCFSelf_Host.ProfileProxy.Profile, object, string>[] Users {
            get {
    ...
    [System.SerializableAttribute()]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(System.Tuple<WCFSelf_Host.ProfileProxy.Profile, object, string>[]))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(System.Tuple<WCFSelf_Host.ProfileProxy.Profile, object, string>))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(WCFSelf_Host.ProfileProxy.Chat))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(WCFSelf_Host.ProfileProxy.Activity))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(WCFSelf_Host.ProfileProxy.Chat[]))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(WCFSelf_Host.ProfileProxy.Group[]))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(WCFSelf_Host.ProfileProxy.Group))]
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ProfileProxy.IChatService", CallbackContract=typeof(WCFSelf_Host.ProfileProxy.IChatServiceCallback))]
    public interface IChatService {
        ...
        void SaveChat(int profileId, WCFSelf_Host.ProfileProxy.Chat chat);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IChatService/SaveChat")]
        System.Threading.Tasks.Task SaveChatAsync(int profileId, WCFSelf_Host.ProfileProxy.Chat chat);
        ...
        WCFSelf_Host.ProfileProxy.Chat[] GetChatsByName(string name, int profileId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetChatsByName", ReplyAction="http://tempuri.org/IChatService/GetChatsByNameResponse")]
        System.Threading.Tasks.Task<WCFSelf_Host.ProfileProxy.Chat[]> GetChatsByNameAsync(string name, int profileId);
        ...
        WCFSelf_Host.ProfileProxy.Group[] GetUsersGroups(int profileId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetUsersGroups", ReplyAction="http://tempuri.org/IChatService/GetUsersGroupsResponse")]
        System.Threading.Tasks.Task<WCFSelf_Host.ProfileProxy.Group[]> GetUsersGroupsAsync(int profileId);
    ...
    public interface IChatServiceCallback {
        ...
        void Notification(WCFSelf_Host.ProfileProxy.Chat chat);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IChatServiceChannel : WCFSelf_Host.ProfileProxy.IChatService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ChatServiceClient : System.ServiceModel.DuplexClientBase<WCFSelf_Host.ProfileProxy.IChatService>, WCFSelf_Host.ProfileProxy.IChatService {
        ...
        public void SaveChat(int profileId, WCFSelf_Host.ProfileProxy.Chat chat) {
            base.Channel.SaveChat(profileId, chat);
        }
        
        public System.Threading.Tasks.Task SaveChatAsync(int profileId, WCFSelf_Host.ProfileProxy.Chat chat) {
        ...
        public WCFSelf_Host.ProfileProxy.Chat[] GetChatsByName(string name, int profileId) {
            return base.Channel.GetChatsByName(name, profileId);
        }
        
        public System.Threading.Tasks.Task<WCFSelf_Host.ProfileProxy.Chat[]> GetChatsByNameAsync(string name, int profileId) {
            return base.Channel.GetChatsByNameAsync(name, profileId);
        }
        
        public WCFSelf_Host.ProfileProxy.Group[] GetUsersGroups(int profileId) {
            return base.Channel.GetUsersGroups(profileId);
        }
        
        public System.Threading.Tasks.Task<WCFSelf_Host.ProfileProxy.Group[]> GetUsersGroupsAsync(int profileId) {
