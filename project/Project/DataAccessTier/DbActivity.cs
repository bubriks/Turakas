...
namespace DataAccessTier
{
    public class DbActivity
    {
        ...
        public int CreateActivity(int profileId, SqlTransaction transaction, SqlConnection connection)
        {
        ...
        public int DeleteActivity(int profileId, int id, SqlTransaction transaction, SqlConnection connection)
        {
